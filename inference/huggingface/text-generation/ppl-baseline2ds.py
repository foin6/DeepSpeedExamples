...
for prompt in inputs:
    ...
    similarity = string_similarity(baseline_out_text, ds_out_text)
...
print_0(f"{'-'*60}")
print_0("The total perplexity of all inputs are:\n{}".format(ppl_list))
print_0("The total similarity of all inputs are:\n{}".format(similar_list))
